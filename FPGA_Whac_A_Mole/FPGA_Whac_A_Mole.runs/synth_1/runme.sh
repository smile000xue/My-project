...
HD_PWD='D:/Project/FPGA/FPGA_Whac_A_Mole/FPGA_Whac_A_Mole.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_game_of_whack_a_mole.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_game_of_whack_a_mole.tcl
