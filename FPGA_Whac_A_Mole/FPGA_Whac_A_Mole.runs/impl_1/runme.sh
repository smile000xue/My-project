...
HD_PWD='D:/Project/FPGA/FPGA_Whac_A_Mole/FPGA_Whac_A_Mole.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_game_of_whack_a_mole.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_game_of_whack_a_mole.tcl -notrace
